...
test("expanded contacts routing covers records messaging reports privacy and booking boundaries", async () => {
  ...
  const cases = [
    ...
    [
      ...
      "contact-categories",
      /Set Up Contact Categories/i,
      /Tools[\s\S]*Contact Categories[\s\S]*category is available on the contact record/i,
    ...
    [
      ...
      "contact-report-export",
      /Run a Contact Report/i,
      /Reports[\s\S]*Hotel[\s\S]*export\/download/i,
      /Add a New Contact|Email Contacts\n/i,
    ],
    [
      "Email all hotel contacts about an event.",
      "contact-email",
      /Email Contacts/i,
      /Email Messaging[\s\S]*Email Contacts[\s\S]*Check the audience/i,
      /do not have a complete verified|Run a Contact Report/i,
    ],
    [
      "Need contact mailshot, not member email.",
      "contact-email",
      /Email Contacts/i,
      /Email Messaging[\s\S]*contacts who should receive the email/i,
      /Distinguish Member Profiles/i,
    ],
    [
      "SMS all society contacts, where is it?",
      "contact-text",
      /Text Contacts/i,
      /Text Messaging[\s\S]*Text Message Contacts[\s\S]*SMS credit balance/i,
      /Filter Contacts by Category/i,
    ],
    [
      ...
      "contact-text",
      /Text Contacts/i,
      /Text Messaging[\s\S]*Select or filter the contacts/i,
      /do not have a complete verified/i,
    ],
    [
      "Import spreadsheet of society contacts.",
      "upload-members-or-contacts",
      /Upload Members or Contacts/i,
      /Upload Members and Contacts[\s\S]*record type[\s\S]*Contacts/i,
      /Run a Contact Report/i,
    ],
    [
    ...
    [
      ...
      "add-contact-company-record",
      /Add a New Contact/i,
      /Contact Category[\s\S]*Company[\s\S]*Other/i,
      /do not have a complete verified/i,
    ],
    [
    ...
    [
      ...
      "contact-clarification",
      /Clarify the Contact Task/i,
      /update contact details[\s\S]*check a booking linked to a visitor/i,
      /do not have a complete verified/i,
    ],
    [
