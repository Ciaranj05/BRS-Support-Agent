...
const DRIVER_RULES = [
  {
    ...
    status: "queued",
    pattern: /(?:\bopen competitions?\b|\bcompetition\b).*terms and conditions|terms and conditions.*(?:\bopen competitions?\b|\bcompetition\b)/i,
    reason: "Open competition terms/search pages belong with competition setup and entry review, not generic reports search.",
  },
  {
  ...
  },
  {
    ...
    tier: "read-and-draft-only",
    status: "queued",
    pattern: /\b(messages on the timesheet|legal messages|membership groups for email and text|email and letter templates|service reminder email)\b|member\s+\[redacted-name\]\s+for email and text/i,
