...
function isCourseWorkRestrictionQuestion(lower = "") {
  const workSignal = hasAny(lower, ["course maintenance", "course work", "greenkeeper", "greenkeepers", "hollow coring", "frost delay", "front nine", "back nine", "course closed", "course closure"]);
  const restrictionSignal = hasAny(lower, ["closed", "close", "block", "restrict", "restriction", "no visitors", "online", "morning", "afternoon", "8", "10"]);
