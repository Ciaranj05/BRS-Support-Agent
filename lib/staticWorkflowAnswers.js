...
export function approvedStaticWorkflowReply(message = "") {
  ...
  if (hasAny(lower, ["club email address", "club email", "main club setup", "club setup page", "system configuration", "feature on or off", "turn a feature", "enable feature", "disable feature"])) {
    return answer("Open System Configuration", [
      "Go to Tools.",
      "Open System Configuration.",
      "Use this area for core club settings such as club contact details, enabled features, and other system-wide options.",
      "Change only the setting the club has asked for, then save and re-check the affected area.",
    ]);
  }
