...
function isGolfEventIntent(lower = "") {
  return hasAny(lower, [
    ...
    hasAny(lower, ["event", "golf day", "society"])
  );
}
...
export function approvedStaticWorkflowReply(message = "") {
  ...
  if (hasAny(lower, ["member billing", "member bill", "membership bill", "members bill"]) && hasAny(lower, ["tee booking", "booking payment", "tee time payment", "booking payments"])) {
  ...
  if (hasAny(lower, ["open competition", "open competitions", "open comp", "open comps"]) && hasAny(lower, ["hotel partner", "paid", "payment", "buggy", "find the booking", "find booking", "separate things"])) {
  ...
  if (!hasAny(lower, ["open competition", "open competitions", "open comp", "open comps"]) && hasAny(lower, ["visitor", "visitors"]) && hasAny(lower, ["online", "website", "web site", "book online", "cant book", "can't book", "cannot book", "not showing", "no tee times", "not available", "not visible", "why"]) && hasAny(lower, ["tee time", "tee times", "booking", "book", "bookings", "wednesday", "days", "next month"])) {
  ...
  if (hasAny(lower, ["upload", "uploads", "import", "imports", "update file", "bulk update", "load file", "load csv", "load a file"]) && (lower.includes("member") || lower.includes("contact"))) {
  ...
  if (hasAny(lower, ["club app message", "app message", "club message", "push notification", "push message"]) && hasAny(lower, ["everyone", "all members", "every member", "everybody"])) {
  ...
  if (hasAny(lower, ["four-ball", "four ball", "fourballs", "four balls", "group size", "max group size"]) && hasAny(lower, ["stop", "restrict", "restriction", "members", "course"])) {
  ...
  if (asksAbout(lower, ["add", "create"], ["visitor contact", "new contact", "society contact", "tour operator contact", "hotel contact"]) || (/\b(add|create)\b/.test(lower) && hasAny(lower, ["hotel", "visitor", "society", "tour operator"]) && lower.includes("contact"))) {
