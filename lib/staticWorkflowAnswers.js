...
function messageDeliveryTroubleshootingAnswer() {
  return detailedAnswer(
    ...
    "For delivery issues, start from the recipient and the exact message that should have reached them. Do not treat this as a new send-email workflow unless you are trying to send a fresh message.",
    [
