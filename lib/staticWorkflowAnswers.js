...
function messageDeliveryTroubleshootingAnswer(lower = "") {
  ...
  if (mentionsEmail && mentionsMember) {
    return answer("Check Why a Member Is Not Receiving BRS Emails", [
      "Open Users, search for the member, and click into the member profile/details page. If the club manages that record through Memberships > Members, open the member profile there instead.",
