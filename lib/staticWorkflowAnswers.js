...
const BILL_PAYMENT_SCHEME_ACTIONS = [
  "apply",
  "applied",
  "attach",
  "attached",
...
export function approvedStaticWorkflowReply(message = "") {
  ...
  if (hasAny(lower, PAYMENT_SCHEME_TERMS) && hasAny(lower, BILL_PAYMENT_SCHEME_ACTIONS)) {
  ...
  if (hasAny(lower, PAYMENT_SCHEME_TERMS) && hasAny(lower, ["create", "add", "new", "set up", "setup", "manage", "change", "edit", "scheduled"])) {
