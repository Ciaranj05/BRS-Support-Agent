...
export function approvedStaticWorkflowReply(message = "") {
  ...
  if (hasAny(lower, ["staff", "user", "users", "assistant"]) && hasAny(lower, ["report", "reports", "access", "permission", "permissions", "can log in"]) && hasAny(lower, ["cannot see", "can't see", "cant see", "can log in", "not see", "access"])) {
