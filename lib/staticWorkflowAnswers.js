...
export function approvedStaticWorkflowReply(message = "") {
  ...
  if (lower.includes("open competition") && hasAny(lower, ["visitors", "visitor", "book online", "online", "fields", "page", "setting up", "set up", "setup"])) {
  ...
  if (hasAny(lower, ["booked", "booking", "reservation"]) && hasAny(lower, ["part of their name", "partial name", "only have a name", "only got a name", "look them up", "find them", "find a person", "customer name"])) {
  ...
  if (hasAny(lower, ["set up a group", "setup a group", "make a group", "create a group", "set up member group", "setup member group", "create member group", "make member group", "member groups for messaging", "groups for messaging"]) && hasAny(lower, ["email", "text", "sms", "message", "messaging"])) {
  ...
  if (lower.includes("open competition") && hasAny(lower, ["terms", "terms and conditions", "conditions", "legal wording"])) {
    return answer("Set Open Competition Terms and Conditions", [
      ...
      "Open Tour Operator Terms and Conditions or the visitor/open-competition terms entry shown for the club.",
