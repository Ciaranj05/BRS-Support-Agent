...
function isCompetitionReportsWebsiteIntent(lower = "") {
  return hasCompetitionTerm(lower) &&
    hasAny(lower, ["report", "reports", "result", "results", "fixture list", "website", "publish", "update"]) &&
    hasAny(lower, ["website", "publish", "showing", "not showing", "fixture", "committee", "result list", "competition report"]);
}
...
function isMemberCompetitionOnlineIntent(lower = "") {
  ...
  const onlineSignal = hasAny(lower, ["online", "website", "book from home", "enter from home", "cannot enter", "can't enter", "cant enter", "not showing", "book into", "enter the comp", "entries"]);
...
function isOpenCompetitionVisitorSetupIntent(lower = "") {
  return hasOpenCompetitionTerm(lower) &&
    hasAny(lower, ["visitor", "visitors", "non member", "non-member", "public", "online", "book online", "cant book", "can't book", "cannot book", "not visible", "not showing", "blank", "publish", "go live", "scratch cup", "fields", "button"]);
}
