...
export function approvedStaticWorkflowReply(message = "") {
  ...
  if (hasAny(lower, ["open competition", "open competitions", "open comp", "open comps"]) && hasAny(lower, ["visitors", "visitor", "book online", "online", "fields", "page", "setting up", "set up", "setup", "can't see", "cant see", "not showing"]) && !hasAny(lower, ["fee", "fees", "price", "prices", "charge", "charges", "cost"])) {
  ...
  if (lower.includes("course restriction") || asksForGroupSizeRestriction || (hasAny(lower, ["stop", "restrict"]) && lower.includes("members") && lower.includes("course"))) {
    return answer("Configure Course Restrictions", [
      "Go to Tools.",
      "Open Course Restrictions.",
      "Use Show expired Course Restrictions if you need to review old restrictions.",
