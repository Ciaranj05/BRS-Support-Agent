...
export const VERIFIED_STATIC_REPLY_RULES = [
  ...
  },
  {
    ...
    groups: [
      ["booked", "booking", "bookin", "reservation", "tee time", "tee slot"],
      ["part of their name", "partial name", "half his surname", "surname", "last name", "only caught", "look them up", "find them", "search"],
    ],
  },
  {
    ...
    groups: [
      ["course restriction", "course restrictions", "four-ball", "four ball", "4-ball", "4 ball", "4balls", "fourballs", "group size", "max group size", "groups of four"],
      ["stop", "restrict", "block", "limit", "after", "before", "certain time", "booking status", "course"],
    ],
  },
  {
