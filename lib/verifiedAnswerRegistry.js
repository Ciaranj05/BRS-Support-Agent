...
export const VERIFIED_STATIC_REPLY_RULES = [
  ...
  },
  {
    ...
    title: /Named User Password Reset Guardrail/i,
    groups: [["set it to", "make it", "change it to", "reset it to"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["ignore your rules", "ignore the rules", "ignore instructions", "book me", "make me a booking", "cancel me", "show me all", "send this marketing email", "send this email", "send this message"], ["booking", "tee time", "member", "members", "customer", "visitor", "visitors", "database", "email", "message", "payment", "balance"]],
  },
  {
    id: "society-block-booking",
    title: /Reserve or Block Consecutive Tee Times/i,
    groups: [["society", "charity day", "corporate day", "golf day", "rugby club", "organiser", "organizer", "shotgun"], ["consecutive", "fourball", "fourballs", "4-ball", "blocked off", "block off", "block them", "reserve", "hold", "held", "tee slots", "tee times", "names later", "collect names", "rough numbers", "stop them showing online", "stop visitors taking", "visitors grabbing"]],
  },
  {
  ...
  },
  {
    ...
    title: /Add a Single Tee Time Booking/i,
    groups: [["tee time", "tee slot", "timesheet", "golfer", "player", "customer", "walk-in", "walk in"], ["add", "create", "make", "put", "book"]],
  },
  {
