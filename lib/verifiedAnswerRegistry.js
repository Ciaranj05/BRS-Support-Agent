...
export const VERIFIED_STATIC_REPLY_RULES = [
  ...
  },
  {
    ...
    groups: [["non-booking", "non booking", "general payment", "payment link", "pay link"], ["payment link", "pay link", "request", "owes", "balance"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["hotel", "society", "tour operator", "company"], ["partner", "company record", "record", "sending guests", "contact"]],
  },
  {
