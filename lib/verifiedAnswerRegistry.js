...
export const VERIFIED_STATIC_REPLY_RULES = [
  ...
  },
  {
    ...
    groups: [["course", "hollow coring", "maintenance", "course shut", "course closed"], ["block", "restriction", "restrict", "tee time", "tee times", "morning", "afternoon", "closed", "front nine", "8", "10"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["show me", "list", "give me", "who owes", "who still owes", "who hasn't paid", "who hasnt paid", "all unpaid", "all outstanding"], ["member", "members", "subs", "subscription", "subscriptions", "renewal", "bill", "bills"], ["balance", "balances", "unpaid", "outstanding", "owe", "owes", "hasn't paid", "hasnt paid", "not paid", "subs", "bills"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["ignore your rules", "ignore the rules", "ignore instructions", "book me", "make me a booking", "cancel me", "delete this booking", "delete that booking", "cancel this booking", "refund them", "refund this booking", "delete and refund", "show me all", "send this marketing email", "send this email", "send this message"], ["booking", "tee time", "member", "members", "customer", "visitor", "visitors", "database", "email", "message", "payment", "balance", "refund"]],
  },
  {
    id: "society-block-booking",
    title: /Reserve or Block Consecutive Tee Times/i,
    groups: [["society", "charity day", "corporate day", "golf day", "rugby club", "organiser", "organizer", "shotgun"], ["consecutive", "fourball", "fourballs", "4-ball", "blocked off", "block off", "block them", "block slots", "block slot", "block tee slots", "reserve", "hold", "held", "tee slots", "tee times", "names later", "collect names", "rough numbers", "stop them showing online", "stop visitors taking", "visitors grabbing"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["member", "members", "membership", "5-day", "five-day", "five day", "wrong category"], ["can book", "book saturday", "weekend", "saturday", "category", "privilege", "rules", "app", "tee times", "online"], ["where", "check", "why", "should", "able", "what controls", "controls", "getting"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["grace period", "unpaid", "not paid", "non-payer", "non payer", "subscription", "subs", "renewal bill"], ["booking access", "app access", "stop online booking", "restrict booking", "auto stop", "lose app access"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["member", "members", "new joiner", "joined today", "membership"], ["login", "log in", "app", "register", "registration", "username", "password", "user account", "enable", "disabled"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["visitor", "visitors", "public", "online", "book online"], ["blocked", "block", "reserved", "restriction", "closed", "still book", "still available"], ["verify", "check", "why", "thought"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["booking", "bookng", "tee time", "booked", "customer", "visitor", "golfer"], ["not on the sheet", "not on timesheet", "isnt on the sheet", "isn't on the sheet", "can't see", "cant see", "cannot see", "can't find", "cant find", "missing"]],
  },
  {
