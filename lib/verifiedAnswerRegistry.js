...
function normaliseTyposForVerified(lower = "") {
  const corrections = [
...
export const VERIFIED_STATIC_REPLY_RULES = [
  ...
  },
  {
    ...
    groups: [["policy", "policies", "foul weather", "bad weather", "weather refund", "rain check", "dumbarnie", "guest rate", "cancellation window", "manager", "committee", "nearby clubs", "another club", "other club", "other clubs", "compared with", "compare with", "should charge"], ["refund", "weather", "rate", "price", "green fee", "visitor", "guest", "cancel"]],
  },
  {
    id: "member-guest-rate-comparison",
    title: /Explain a Member Guest Rate Difference/i,
    groups: [["member guest", "member guests", "members guest", "guest rate"], ["why", "higher", "lower", "more expensive", "cheaper", "than", "compare", "compared"]],
  },
  {
    id: "marketing-consent-filtering",
    title: /Email Only Opted-In Contacts/i,
    groups: [["marketing", "consent", "opted in", "opt-in", "opted out", "opt-out", "unsubscribe", "remove me", "offers", "offer", "sale", "sales", "never opted in", "booked once", "gdpr"], ["email", "text", "sms", "visitor", "visitors", "customer", "customers", "contact", "contacts", "member", "members", "imported", "captured", "online bookings", "tour operator"]],
  },
  {
    id: "contact-live-record-guardrail",
    title: /Chatbot Guidance for Live BRS Contact Records/i,
    groups: [["contact", "contacts", "visitor contact", "visitor details", "customer details", "email you hold", "phone number", "contact data", "database", "gdpr"], ["can you", "could you", "will you", "delete", "remove", "look up", "paste", "tell me", "show me", "export all", "send", "for me", "right now", "here", "wants all"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["ignore your rules", "ignore the rules", "ignore instructions", "book me", "can you book", "could you book", "will you book", "make me a booking", "cancel me", "delete this booking", "delete that booking", "cancel this booking", "refund them", "refund this booking", "refund every", "delete and refund", "squeeze a tee time", "squeeze this tee time", "show me all", "send this marketing email", "send this email", "send this message", "can you enter", "enter john", "delete sarah", "run the draw", "paste all", "paste current", "paste the current"], ["booking", "tee time", "tee slot", "member", "members", "customer", "visitor", "visitors", "database", "email", "message", "payment", "balance", "refund", "live brs sheet", "john smith", "competition", "comp", "entry", "draw", "captain's prize", "captain prize", "green fee", "rate table", "rates", "price", "tour operator", "member guest"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["refund", "money back", "reverse", "return", "return card money", "refund button", "green fee back"], ["visitor", "tee time", "booking", "card payment", "paid online", "online payment", "green fee", "brs payments", "saturday golf", "player", "4ball", "fourball", "3ball", "threeball", "one player", "one visitor"]],
  },
  {
    id: "booking-payment-check",
    title: /Check Payments on a Booking/i,
    groups: [["payment", "paid", "succeeded", "brs payments", "transaction"], ["booking", "tee", "cross-check", "cross check", "wrong", "status"]],
  },
  {
    id: "non-brs-payment-refund-boundary",
    title: /Non-BRS Payment Refund Boundary/i,
    groups: [["cash", "pdq", "card terminal", "terminal", "cheque", "bank transfer", "offline", "non-brs", "non brs"], ["refund", "reverse", "payment", "paid", "deposit"]],
  },
  {
    id: "payment-data-privacy",
    title: /Payment Data Privacy Guardrail/i,
    groups: [["card", "transaction", "transactions", "payment", "payment link", "payout", "customer", "email", "amount"], ["show me", "give me", "list", "paste", "what did", "card number", "customer emails", "all transactions", "payment links"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["competition", "competitions", "comp", "leaderboard", "scores", "scoring"], ["score", "scores", "scoring", "leaderboard", "results", "result sync", "golf genius", "handicapmaster", "handicap master", "club systems"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["copy"], ["services", "catering", "green fee", "green fees", "green fee rates", "next year", "from year", "to year", "2026", "2027", "copy year"]],
  },
  {
    id: "legal-messages",
  ...
  },
  {
    ...
    groups: [["open competition", "open competitions", "open comp", "open comps", "all ireland"], ["terms", "terms and conditions", "conditions", "search", "legal", "wording", "entry"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["open competition", "open competitions", "open comp", "open comps", "opne comp", "scratch cup"], ["visitor", "visitors", "visotrs", "non member", "online", "club website", "book online", "enter", "entries", "fields", "page", "can't see", "cant see", "cant book", "booking", "visible", "blank", "publish", "go live", "button"]],
  },
  {
    id: "member-competition-online",
    title: /Set Up a Members Competition for Online Booking/i,
    groups: [["competition", "competitions", "comp", "medal"], ["member", "members", "captain"], ["online", "website", "book", "enter", "entries", "not showing"]],
  },
  {
    id: "competition-entry-change",
    title: /Change or Cancel a Competition Entry/i,
    groups: [["competition", "competitions", "comp", "compettion", "entry", "entery", "entrant", "player", "open comp"], ["change", "chnage", "cancel", "remove", "amend", "withdraw", "withdrew", "pulled out", "refund", "paid", "paying", "vanished", "wrong tee time", "entry sheet", "quick"]],
  },
  {
    id: "competition-draw-sheet",
    title: /Open the Competition Entry Sheet or Draw/i,
    groups: [["competition", "competitions", "comp", "compettion", "medal"], ["entry sheet", "draw", "draw sheet", "start sheet", "comp sheet", "shet", "tee times"]],
  },
  {
    id: "competition-website-reports",
    title: /Update Club Website Competition Reports/i,
    groups: [["competition", "competitions", "comp", "open comp"], ["report", "reports", "result", "results", "fixture", "committee", "result list"], ["website", "publish", "update", "showing", "area"]],
  },
  {
    id: "competition-mixed-charges",
    title: /Check Visitor Charges for an Open Competition|Check Competition Payments and Entry Fees|Member Competition Charges/i,
    groups: [["competition", "competitions", "comp"], ["member", "members"], ["visitor", "visitors", "guest", "guests"], ["charge", "charges", "fee", "fees", "price", "mixed up"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["competition", "comp sheet", "comp"], ["waiting list", "wait list", "waitlist", "missed", "full"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["vat", "tax report", "tax figures"], ["report", "reports", "download", "export", "month", "card transactions", "accountant"]],
  },
  {
    id: "brs-payments-transactions",
    title: /Download BRS Payments Transactions|View BRS Payments Transactions/i,
    groups: [["brs payments", "card payment", "card payments", "paymnts", "payments", "online payment"], ["transaction", "transactions", "csv", "download", "export", "accountant", "find", "search", "email", "amount", "status", "cross-check", "cross check"]],
  },
  {
    id: "brs-payments-refunds",
    title: /View BRS Payments Refunds/i,
    groups: [["refund", "refunds"], ["history", "record", "records", "previous", "already processed", "find", "search", "export", "customer"]],
  },
  {
    id: "brs-payments-payouts",
    title: /View BRS Payments Payouts/i,
    groups: [["payout", "payouts", "paid us out", "bank deposit"], ["summary", "report", "review", "find", "where", "see", "when", "transactions", "bank", "last week", "match"]],
  },
  {
    id: "brs-payments-setup",
    title: /Configure BRS Payments Setup/i,
    groups: [["brs payments", "brs pay", "payment processor", "online payments", "card payments"], ["setup", "configure", "configuration", "settings", "go-live", "go live", "enable", "check"]],
  },
  {
    id: "payment-methods",
    title: /Set Up Payment Methods/i,
    groups: [["payment method", "payment methods", "payment method label", "payment method name"], ["cash", "cheque", "bank transfer", "label", "reports", "add", "edit", "save", "field", "page", "where"]],
  },
  {
    id: "general-payment-request",
    title: /Create a General Payment Request/i,
    groups: [["non-booking", "non booking", "general payment", "payment request", "request payment", "payment link", "pay link", "society organiser", "society organizer", "room hire", "function room", "facility", "catering", "food"], ["payment link", "pay link", "request", "owes", "balance", "deposit", "hire", "catering"]],
  },
  {
    id: "general-payment-refund",
    title: /Refund a General Payment Request/i,
    groups: [["general payment request", "payment request", "payment link", "pay link", "non-booking", "room hire", "function room", "society deposit", "deposit"], ["refund", "reverse", "money back", "paid twice", "duplicate payment"]],
  },
  {
    id: "booking-payment-requests",
    title: /View Booking Payment Requests/i,
    groups: [["booking payment request", "booking pay request", "payment request", "payment link"], ["booking", "tee", "visitor", "status", "sent", "find", "review", "unpaid"]],
  },
  {
    id: "competition-payments",
    title: /Check Competition Payments and Entry Fees|Configure Member Competition Charges/i,
    groups: [["competition", "comp", "open competition", "open comp", "entry fee", "competition purse", "purse"], ["payment", "paid", "fee", "refund", "withdrawal", "green fee", "charge", "purse"]],
  },
  {
    id: "payment-triage",
    title: /Triage a BRS Payment Issue/i,
    groups: [["payment", "paid", "pay"], ["not working", "problem", "failed", "customer says they paid"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["twilight", "off peak", "off-peak", "quiet afternoon", "dynamic pricing", "cheaper", "cheaper online"], ["green fee", "green fees", "price", "prices", "pricing", "rate", "rates", "visitor", "online", "club web"]],
  },
  {
    id: "visitor-booking-rates",
    title: /Set Visitor Booking Rates|Set Visitor \/ Agent Online Green Fee Rates|Set Up Green Fee Rates|Set Tour Operator Booking Rates/i,
    groups: [["visitor", "visitors", "tour operator", "tour operators", "tee time agent", "tee time agents", "agent", "agents", "club website", "website"], ["green fee", "green fees", "price", "prices", "rate", "rates", "online booking", "no show", "not showing", "package"]],
  },
  {
    id: "day-ticket-rates",
    title: /Set Day Ticket Rates for Visitors/i,
    groups: [["day ticket", "day tickets", "two rounds", "2 rounds"], ["visitor", "visitors", "green fee", "rate", "price", "online", "same day"]],
  },
  {
    id: "assign-green-fee-reservation",
    title: /Assign a Green Fee to a Reservation/i,
    groups: [["green fee", "rate"], ["reservation", "booking", "timesheet", "booking details"], ["put", "assign", "select", "choose", "correct"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["hotel", "society", "tour operator", "company", "corporate"], ["partner", "company record", "company and person", "put both", "person", "record", "sending guests", "sends visitors", "store", "details", "contact", "category"]],
  },
  {
    id: "add-contact",
    title: /^Add a New Contact/i,
    groups: [["contact", "contct", "visitor", "society", "hotel", "tour operator", "tour opperator", "opperator", "company", "corporate"], ["add", "create", "new", "record", "details", "store", "company/group", "company record", "category"]],
  },
  {
    id: "contact-find",
    title: /Find a Contact Record/i,
    groups: [["contact", "contacts", "society", "hotel", "tour operator", "visitor"], ["find", "search", "look up", "lookup", "where", "view", "only have", "company name", "email address", "phone number"]],
  },
  {
    id: "contact-edit",
    title: /Change a Contact's Details/i,
    groups: [["contact", "society", "hotel", "tour operator", "visitor"], ["change", "update", "edit", "modify", "amend", "wrong", "changed"], ["email", "mobile", "phone", "address", "name", "details"]],
  },
  {
    id: "contact-delete",
    title: /Delete or Remove a Contact Record/i,
    groups: [["contact", "contacts", "society", "hotel", "tour operator", "visitor"], ["delete", "remove", "deactivate", "bulk", "duplicate", "temporary", "old"]],
  },
  {
    id: "contact-categories",
    title: /Set Up Contact Categories/i,
    groups: [["contact type", "contact category", "contact categories", "contact cat", "contact cats", "contact records", "categories shown", "contct cat", "contct", "categori", "society organiser", "society organisers", "tour operator", "tour operators", "opperator", "opperators"]],
  },
  {
    id: "contact-filter",
    title: /Filter Contacts by Category/i,
    groups: [["contact", "contacts", "society", "hotel", "tour operator", "visitor"], ["filter", "show only", "only", "find all", "list by type", "by type", "category", "type"]],
  },
  {
  ...
  {
    id: "contact-email",
    title: /Email Contacts/i,
    groups: [["email", "mail", "mailshot"], ["contact", "contacts", "society", "hotel", "tour operator", "member email"]],
  },
  {
    id: "contact-text",
    title: /Text Contacts/i,
    groups: [["text", "txt", "sms"], ["contact", "contacts", "society", "tour operator", "category"]],
  },
  {
    id: "contact-duplicate",
    title: /Handle Duplicate Contact Records/i,
    groups: [["duplicate", "same visitor", "two contact", "two records", "merge", "old email"], ["contact", "contacts", "record", "records", "member"]],
  },
  {
    id: "contact-booking-boundary",
    title: /Choose Search Bookings or Contacts for Visitor Details/i,
    groups: [["booking", "tee time", "confirmation", "booking reference", "visitor booked", "golfer rang"], ["contact", "email", "phone", "mobile", "postcode", "visitor details", "customer name", "old email", "not sure"]],
  },
  {
    id: "contact-member-boundary",
    title: /Distinguish Member Profiles from Contact Records/i,
    groups: [["member", "membership", "member profile", "member email", "app", "became member"], ["contact", "contacts", "visitor", "customer", "society"]],
  },
  {
    id: "contact-clarification",
    title: /Clarify the Contact Task/i,
    groups: [["contact", "contacts", "visitor details", "customer record wrong"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["member billing", "member bill", "membership bill", "member account balance", "account balance", "annual subs", "subs", "subscription", "membership payment"], ["tee booking", "booking payment", "booking payments", "visitor booking payment", "tee booking payment"]],
  },
  {
...
export function verifiedStaticReplyMatch(message = "", reply = "") {
  ...
  const lower = normaliseTyposForVerified(normalise(message));
