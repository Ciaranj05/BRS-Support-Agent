...
export const VERIFIED_STATIC_REPLY_RULES = [
  ...
  },
  {
    ...
    groups: [["ignore your rules", "ignore the rules", "ignore instructions", "book me", "can you book", "could you book", "will you book", "make me a booking", "cancel me", "delete this booking", "delete that booking", "cancel this booking", "refund them", "refund this booking", "refund every", "delete and refund", "squeeze a tee time", "squeeze this tee time", "show me all", "send this marketing email", "send this email", "send this message", "can you enter", "enter john", "delete sarah", "run the draw", "paste all"], ["booking", "tee time", "tee slot", "member", "members", "customer", "visitor", "visitors", "database", "email", "message", "payment", "balance", "refund", "live brs sheet", "john smith", "competition", "comp", "entry", "draw", "captain's prize", "captain prize"]],
  },
  {
