...
export const VERIFIED_STATIC_REPLY_RULES = [
  ...
  },
  {
    ...
    groups: [["message", "notice", "warning", "warning note", "frost delay", "delay notice", "recurring message"], ["timesheet", "tee sheet", "teesheet", "sheet"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["ignore your rules", "ignore the rules", "ignore instructions", "book me", "make me a booking", "cancel me", "delete this booking", "delete that booking", "cancel this booking", "refund them", "refund this booking", "delete and refund", "squeeze a tee time", "squeeze this tee time", "show me all", "send this marketing email", "send this email", "send this message"], ["booking", "tee time", "member", "members", "customer", "visitor", "visitors", "database", "email", "message", "payment", "balance", "refund", "live brs sheet"]],
  },
  {
