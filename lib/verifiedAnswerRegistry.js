...
export const VERIFIED_STATIC_REPLY_RULES = [
  ...
  },
  {
    ...
    groups: [["show me", "list", "give me", "who owes", "who still owes", "who hasn't paid", "who hasnt paid", "all unpaid", "all outstanding"], ["member", "members"], ["balance", "balances", "unpaid", "outstanding", "owe", "owes", "hasn't paid", "hasnt paid", "not paid", "subs", "bills"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["society", "charity day", "corporate day", "golf day", "rugby club", "organiser", "organizer", "shotgun"], ["consecutive", "fourball", "fourballs", "4-ball", "blocked off", "block off", "reserve", "hold", "held", "tee slots", "names later", "stop them showing online", "visitors grabbing"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["member", "members", "membership", "5-day", "five-day", "five day", "wrong category"], ["can book", "book saturday", "weekend", "saturday", "category", "privilege", "rules", "app"], ["where", "check", "why", "should", "able"]],
  },
  {
