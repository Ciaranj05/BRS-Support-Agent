...
export const VERIFIED_STATIC_REPLY_RULES = [
  ...
  },
  {
    ...
    groups: [["refund", "money back", "reverse", "return", "refund button", "green fee back"], ["visitor", "tee time", "booking", "card payment", "paid online", "online payment", "green fee", "brs payments", "saturday golf", "4ball", "fourball", "3ball", "threeball", "one player", "one visitor"]],
  },
  {
  ...
  },
  {
    ...
    groups: [["payment"], ["not working", "problem", "failed", "customer says they paid"]],
  },
  {
