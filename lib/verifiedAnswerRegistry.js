...
export const VERIFIED_STATIC_REPLY_RULES = [
  ...
  },
  {
    ...
    groups: [["competition", "competitions", "comp", "entry", "entrant", "player", "open comp"], ["change", "cancel", "remove", "amend", "withdraw", "withdrew", "pulled out", "refund", "paid", "paying", "vanished", "wrong tee time", "entry sheet"]],
  },
  {
  ...
  },
  {
    ...
    title: /Check Competition Payments and Entry Fees/i,
    groups: [["competition", "open competition", "open comp", "entry fee", "competition purse", "purse"], ["payment", "paid", "fee", "refund", "withdrawal", "green fee", "charge"]],
  },
  {
    id: "payment-triage",
