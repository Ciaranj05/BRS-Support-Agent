...
const LIVE_LOOKUP_ENABLED = LIVE_LOOKUP_FLAG === "true" || (process.env.VERCEL === "1" && LIVE_LOOKUP_FLAG !== "false");
...
export function isLiveLookupRuntimeConfigured() {
  return Boolean(LIVE_WORKER_URL || BROWSER_WS_ENDPOINT || ALLOW_DIRECT_LOOKUP);
}
