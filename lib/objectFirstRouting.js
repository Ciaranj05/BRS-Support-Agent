...
1. Open Competitions and find the relevant member competition.
2. Use the competition setup, charges, and purse/payment settings for that competition.
3. Confirm the member entry fee is being taken from the member's competition purse.
4. Do not use membership billing or a generic payment request for member competition charges.
