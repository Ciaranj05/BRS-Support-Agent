...
Open Memberships from the main navigation menu, find the member in the Members area, open the member profile, then use the Billing area on that profile. Open the bill and use its Payments section before refunding or reversing anything. If the payment was taken through BRS Payments, review refund records under Tools >> BRS Payments >> Refunds.`, "memberships");
  }
