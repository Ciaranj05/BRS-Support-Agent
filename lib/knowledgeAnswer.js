...
const SOURCE_WEIGHT = { system: 5, manual: 4, local: 4, help: 3 };
...
function keywordIntent(message = "") {
  ...
  return {
    topic,
    task: lower.includes("report") || lower.includes("show") || lower.includes("find me") ? "report" : lower.includes("refund") ? "refund" : lower.includes("create") || lower.includes("add") ? "create" : "support-answer",
    object,
