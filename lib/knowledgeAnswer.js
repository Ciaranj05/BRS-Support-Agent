...
export async function answerFromKnowledge(message) {
  ...
  const response = await client.responses.create({
    ...
    input: [
      {
        role: "system",
        content: `You are a technical support agent for BRS Golf admin/staff users. Use strict evidence-led routing: answer only from supplied evidence that directly proves the classified topic/object and workflow.
