...
function isTimesheetContentGuidance(message) {
  return /\b(message|note|notice|warning|text|print|view|open|find|search|interval|intervals|start of|end of|beginning of|first tee time|last tee time|earlier|later|more tee times|extra tee times|additional tee times|booking|reservation|golfer|player|customer|visitor)\b/i.test(normaliseMessage(message));
}
